...
class PrintValue : public BT::SyncActionNode {
 public:
  ...
  static BT::PortsList providedPorts() { return {BT::InputPort<int>("message")}; }
};
...
class AddTwoIntsAction : public RosServiceNode<behaviortree_ros::AddTwoInts> {
 public:
  AddTwoIntsAction(ros::NodeHandle& handle, const std::string& node_name, const NodeConfiguration& conf) : RosServiceNode<behaviortree_ros::AddTwoInts>(handle, node_name, conf) {}

  static PortsList providedPorts() { return {InputPort<int>("first_int"), InputPort<int>("second_int"), OutputPort<int>("sum")}; }
...
class FibonacciServer : public RosActionNode<behaviortree_ros::FibonacciAction> {
 public:
  FibonacciServer(ros::NodeHandle& handle, const std::string& name, const NodeConfiguration& conf) : RosActionNode<behaviortree_ros::FibonacciAction>(handle, name, conf) {}

  static PortsList providedPorts() { return {InputPort<int>("order"), OutputPort<int>("result")}; }
